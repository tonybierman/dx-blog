...
pub async fn fetch_comment_by_id_db(
    pool: &SqlitePool,
    id: i64,
...
pub async fn moderate_comment_db(
    pool: &SqlitePool,
    id: i64,
    status: &str,
) -> Result<(), sqlx::Error> {
...
pub async fn delete_comment_db(pool: &SqlitePool, id: i64) -> Result<(), sqlx::Error> {
